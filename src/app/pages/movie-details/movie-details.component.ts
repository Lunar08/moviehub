...
export class MovieDetailsComponent implements OnInit {
  ...
  constructor(private service:MovieApiServiceService,private router:ActivatedRoute,private title:Title,private meta:Meta, private wishlistService: WishlistService) { }
  ...
  addToWishlist(movie: any): void {
    const existsInWishlist = this.wishlistService.isInWishlist(movie);
